...
//    private Button pickPlaceButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setUserInfoChangedCallback(new LoginButton.UserInfoChangedCallback() {
            ...
            public void onUserInfoFetched(GraphUser user) {
                FacebookConnActivity.this.user = user;
                updateUI();
    ...
    private void onSessionStateChange(Session session, SessionState state, Exception exception) {
        if (pendingAction != PendingAction.NONE &&
                ...
                new AlertDialog.Builder(FacebookConnActivity.this)
...
//            Bitmap image = BitmapFactory.decodeResource(this.getResources(), R.drawable.icon);
            ...
            Bundle paramsIntent = intent.getExtras();
            Bitmap image;
        	byte[] picture = paramsIntent.getByteArray("imagem");
        	
        	if(picture == null){
        		image = BitmapFactory.decodeResource(this.getResources(), R.drawable.default1);
        	}else{
            ...
            params.putString("message", "Estou ouvindo no PlayerTags: " + paramsIntent.getString("musica"));  
    ...
    private void showPickerFragment(PickerFragment<?> fragment) {
        fragment.setOnErrorListener(new PickerFragment.OnErrorListener() {
            ...
            public void onError(PickerFragment<?> pickerFragment, FacebookException error) {
                ...
                Toast toast = Toast.makeText(FacebookConnActivity.this, text, Toast.LENGTH_SHORT);
                toast.show();
            }
        });
